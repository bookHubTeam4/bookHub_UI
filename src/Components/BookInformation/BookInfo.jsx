...
class BookInfo extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      LoggedInFlag: false,
      buttonClicked: false,
      button1: Style.secondary,
      button2: Style.secondary,
      button3: Style.secondary
    };
        ...
        <React.Fragment>
          ...
          <div className={Style.content}>
            ...
            <div className={Style.btngrp}>
              <Button className={this.state.button1} onClick={() => this.check(1)}>
                Add To Reading List
              </Button>{" "}
              <Button className={this.state.button2} onClick={() => this.check(2)}>
                Reading
              </Button>{" "}
              <Button className={this.state.button3} onClick={() => this.check(3)}>
                Read
              </Button>{" "}
            </div>
          </div>
